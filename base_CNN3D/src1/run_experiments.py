...
def main():
    ...
    parser.add_argument('--time_slice', type=slice, default=slice(0,10), help='Which years to take')
    parser.add_argument('--var', type=str, default='pr', help='We are working with precipitation data')
    
    parser.add_argument('--data_scale', type=float, default=10, help='Independent parameter for scaling train data amount')
